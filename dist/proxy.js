(function (global, factory) {
  ...
  ProxyPolyfill = function(target, handler) {
    ...
    if (handler.get || !prototypeOk) {
      for (var k$1 in target) {
        if (propertyMap[k$1]) {
          continue;
        }
        Object.defineProperty(proxy, k$1, { get: getter.bind(target, k$1) });
      }
    }
  ...
  var ProxyPolyfill$1 = ProxyPolyfill;
  ...
  var index = win.Proxy || ProxyPolyfill$1;
